        ...
        <View style={{ backgroundColor: tema.background, flex: 1 }}>
            <ScrollView style={{ flex:1}}>
                <View style={{borderWidth:1,borderBlockColor:tema.primary,padding:8}}>
                    <Text style={{ color: tema.active, fontWeight: "bold", textAlign: "center",fontSize:20}}>TÉRMINOS Y CONDICIONES DE USO DE LA APLICACIÓN DE RUDDY PAZ</Text>
                    <View style={{ width: "90%", marginLeft: "5%", marginRight: "5%" }}>
                        <Text style={{ color: tema.active }}>Bienvenido a nuestra aplicación de Ruddy Paz. Que operan bajo las licencias de los sistemas y tecnologías Servisofts®. Antes de utilizar nuestros servicios, te pedimos que leas detenidamente los siguientes términos y condiciones. Al acceder y utilizar nuestra aplicación, aceptas cumplir con estos términos y condiciones.</Text>
                        ...
                        <Text style={{ color: tema.active, fontWeight: "bold" }}>2.	Normativas del Mercado:</Text>
                        <Text style={{ color: tema.active, width: "90%", marginLeft: "10%" }}>
                            o	La aplicación esta fundamentada y elaborada en estricto rigor de la veracidad y correcta clasificación de la información cumpliendo con todas las normativas vigentes del mercado y sus alianzas corporativas.
                        </Text>
                        <Text style={{ color: tema.active, width: "90%", marginLeft: "10%" }}>
                        ...
                        <Text style={{ color: tema.active, width: "90%", marginLeft: "10%" }}>
                            o	En el caso de solicitudes de información por parte de compañías, agentes, y/o ajustadores, el usuario reconoce que la información registrada se considera como parte de una declaración jurada.
                        </Text>
                        <Text style={{ color: tema.active, width: "90%", marginLeft: "10%" }}>
