        ...
        <SafeAreaView style={{ height: "110%", justifyContent: "center", alignItems: "center", backgroundColor: tema.background }}>
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', }}>
                <View style={{display:"flex", flexWrap:"wrap", flexDirection:"row"}}>
                    <Text style={{ alignItems: 'center', fontWeight: 'bold', color: tema.primary, fontSize:35, fontStyle: "italic" }}>Ruddy</Text>
                    <Text style={{ alignItems: 'center', fontWeight: 'bold', color: tema.active, fontSize:35, fontStyle: "italic" }}> Paz Demiquel</Text>
                </View>
                ...
                <View style={{display:"flex", flexDirection:"row"}}>
                    ...
                    <Text style={{ alignItems: 'center', color: tema.active }}>Servisofts Srl.</Text>
                </View>
            </View>
